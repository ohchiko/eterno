        ...
        return [
            ...
            m('.w-full.block.flex-grow.lg:flex.lg:items-center.lg:w-auto', [
                !_isEmpty(User.current) ? [
                    m('.text-sm.lg:flex-grow', User.current.roles[0].name === 'admin' ? [
                    ...
                    ] : User.current.roles[0].name === 'school' ? [
                        ...
                        m('a[href=/visitor].mt-4.inline-block.lg:mt-0.text-gray-500.mr-4', { oncreate: m.route.link }, 'Visitor'),
