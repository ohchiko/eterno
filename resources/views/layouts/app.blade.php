...
=======
        <nav class="flex items-center justify-between flex-wrap bg-white p-6">
            ...
            <div class="block lg:hidden">
                <button class="flex items-center px-3 py-2 border rounded text-gray-500 border-teal-400 hover:text-white hover:border-white">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-sm lg:flex-grow">
                    @if (Auth::user()->admin())
                        <a href="/#/users" class="block mt-4 lg:inline-block lg:mt-0 text-gray-500 mr-4">
                            Users
                        </a>
                        <a href="/#/logs" class="block mt-4 lg:inline-block lg:mt-0 text-gray-500 mr-4">
                            Logs
                        </a>
                    ...
                    @else
                        <a href="/#/books" class="block mt-4 lg:inline-block lg:mt-0 text-gray-500 mr-4">
                            Books
                        </a>
                        <a href="/#/account" class="block mt-4 lg:inline-block lg:mt-0 text-gray-500 mr-4">
                            Account
                        </a>
                    @endif
                </div>
